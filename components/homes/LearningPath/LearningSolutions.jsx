      ...
      <div className="container">
        <div className="row y-gap-30 items-center">
          <div className="col-lg-6 order-2 order-lg-1">
            ...
            Enhancing Education with AI Precision & Blockchain Perks:

              <br className="lg:d-none" />  Own, Learn, and Earn
            </p>
            <p className="text-dark-1 mt-20">
            Dive Deeper into the Future of Interactive Learning
            </p>
          ...
          <div className="col-lg-6 order-1 order-lg-2">
            <div className="elements-image  elements-image-learning">
              ...
              >
                ...
                <div className="ml-20">
                  ...
                  <div className="mt-3">Unique Courses</div>
                </div>
              </div>
              ...
              >
                ...
                <div className="">
                  ...
                  <div className="mt-3"> AI Tutoring</div>
                </div>
              </div>
            </div>
          </div>
