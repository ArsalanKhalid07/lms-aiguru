export const learningPath = [
  {
    ...
    description:
      "Got questions? Our AI is always on standby, ready to provide immediate answers, making learning seamless and efficient",
  },
  {
    id: "item2",
    iconBg: "bg-purple-2",
    iconSrc: "/assets/img/home-2/learning/icons/2.svg",
    title: "Blockchain Benefits for All",
    description:
      "We've got you covered from free learning opportunities with NFTs to exclusive discounts using our platform tokens",
  },
  {
    id: "item3",
    iconBg: "bg-orange-2",
    iconSrc: "/assets/img/home-2/learning/icons/3.svg",
    title: "Invest, Own, and Prosper",
    description:
      "Elevate your investment game by owning courses and enjoying a steady stream of passive income, redefining the educational business model.",
  },
];
